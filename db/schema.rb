...
ActiveRecord::Schema.define(version: 2022_06_12_233356) do
  ...
  create_table "publications", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.integer "user_id"
    t.string "comuna_partida"
    t.string "comuna_llegada"
    t.time "hora"
  end
  ...
  create_table "solicituds", force: :cascade do |t|
    ...
    t.index ["user_id", "publication_id"], name: "index_solicituds_on_user_id_and_publication_id", unique: true
